      ...
      >
        ...
        >
          <div
            className={
              !hover
                ? "opacity-0 absolute left-0 top-0 bg-hover py-1 px-2 rounded-full z-40 text-xs transition-all duration-700"
                : "transition-all duration-700 absolute left-0 top-0 bg-hover py-1 px-2 rounded-full z-40 text-xs"
            }
          >
            -33%
          </div>
