  ...
  return (
    <div className="">
      ...
      <div className="w-full h-full flex justify-center items-center my-48">
        <div className="w-1/3 reset-pwd bg-white shadow-lg rounded-lg p-6 gap-6 flex flex-col">
          <h1 className=" text-center text-xl font-semibold">CREATE ACCOUNT</h1>
          <div>
            <h1 className="text-xl warning leading-9">
              {" "}
          ...
          <div className="flex flex-col justify-center items-center mt-6 gap-6">
            ...
            <Link to="/account/log-in">Cancel</Link>
          </div>
        </div>
      </div>
    </div>
